...
function cargar_modal($id){ ?>
  <div class="modal-dialog modal-lg" style="position:relative">
      ...
      <!-- Modal heading -->
        <div class="modal-header">
          <button type="button" class="close" onclick="cancelar();" aria-hidden="true">&times;</button>
            ...
            <form class="form-horizontal" id="form_foto" role="form">
              ...
              <div class="form-group" align="center">
                <div class="form-group">
                  ...
                  <button type="button" class="btn btn-default" onclick="cancelar()" aria-hidden="true"><i class="fa fa-times"></i> Cancelar</button>
                </div>
              </div>
            </form>
          </div>
  ...
  (function() {
    ...
    function subir_foto() {
      ...
      xhr.open('POST','Usuarios/do_upload?id='+<?=$id?>,true);
      ...
      xhr.onreadystatechange=function() {
        if (xhr.readyState==4) {
          ...
          swal({
            ...
            type: 'error',
            confirmButtonColor: '#ff9933'
          }).then( function() { $('#modalcontent').modal('hide'); });
        }
      }
      xhr.send(data);
    }
