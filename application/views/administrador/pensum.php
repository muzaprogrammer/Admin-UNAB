...
<body class="" onload="load_pensum()">
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <span class="btn btn-success" onclick="registrar();"><i class="fa fa-plus"></i>Agregar Pensum</span>
                <br/>
                <hr class="separator" />
  ...
  <script src="<?=base_url();?>js/administrador/pensum.js"></script>
</body>
</html>
