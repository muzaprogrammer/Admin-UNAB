...
<body class="" onload="load_materias()">
  <section id="container">
    <?php $opt="admin_materias";?>
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Administracion de Materias</h3>
              ...
              <div class="panel-body">
                <span class="btn btn-success" onclick="registrar();"><i class="fa fa-plus"></i>Agregar Materia</span>
                <br/>
                <hr class="separator" />
  ...
  <script src="<?=base_url();?>js/administrador/materia.js"></script>
</body>
</html>
