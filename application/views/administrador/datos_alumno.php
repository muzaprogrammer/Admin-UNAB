                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                             <input class="form-control" id="carnet" name="carnet" onkeyup="correo();" type="text" data-mask="99-9999-9999" value="<?=$datos['carnet']?>"/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                             <input class="form-control" id="nom_completo" name="nom_completo" type="text" value="<?=$datos['nom_completo']?>" readonly/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                             <input class="form-control" id="nombre" name="nombre" onkeyup="nombre_completo()" value="<?=$datos['nombre']?>" type="text" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                						...
                						<div class="col-md-9">
                              <input class="form-control" id="apellido" name="apellido" onkeyup="nombre_completo()" value="<?=$datos['apellido']?>" type="text" />
                            </div>
                					</div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                						...
                						<div class="col-md-9">
                              <input type="text" id="fecha_nac" onkeyup="calcular_edad()" data-mask="99-99-9999" value="<?=$datos['fecha_nac']?>" name="fecha_nac" class="form-control span8 inputmask" placeholder="dd-mm-yyyy" />
                            </div>
                					</div>
                        </div>
                        <div class="col-md-6">
