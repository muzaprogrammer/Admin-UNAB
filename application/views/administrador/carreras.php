...
<body class="" onload="load_carreras()">
  <section id="container">
    <?php $opt="admin_carreras"?>
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Administracion de Carreras</h3>
              ...
              <div class="panel-body">
                <span class="btn btn-success" onclick="registrar();"><i class="fa fa-plus"></i>Agregar Carrera</span>
                <br/>
                <hr class="separator" />
  ...
  <script src="<?=base_url();?>js/administrador/carreras.js"></script>
</body>
</html>
